...
可蒂九表情头像位于`assets/portraits/keti/`，默认/哭泣标记已接DialoguePanel；源图与标准处理入口见`KETI_PORTRAIT_REVIEW.md`，待视觉审阅；制作人批准与本轮试玩优化一起提交推送。

2026-09-12限定角色接入：六人小人见 `assets/characters/{keti,ajie,lisi,ajian,buck,miro}/`，每人包括source、walk、idle、frames与导入校验记录。地图、角色载荷与胃袋已引用正式小人；六人移动已验收，专用倒地/尸体/攻击/骑乘仍未完成。标准程序和入口见 `NPC_ART_PIPELINE.md`。制作人批准与本轮优化一起提交推送，以下旧占位记录保留用于区分历史基线。
