...
const MAPS := {
	&"prologue_tutorial": {
		"title": "序章 · 教学长廊", "scene": "res://game/maps/levels/prologue_tutorial.tscn", "size": Vector2i(72, 48), "spawn": Vector2(8.5, 24.5),
		"direction": Vector2.RIGHT, "walkable": Rect2i(4, 16, 51, 16), "beans": [Vector2i(16,24), Vector2i(24,24), Vector2i(32,24), Vector2i(42,24), Vector2i(48,24), Vector2i(51,24)],
	...
	&"wilderness": {
		"title": "荒野", "scene": "res://game/maps/levels/wilderness.tscn", "size": Vector2i(72, 48), "spawn": Vector2(7.5, 24.5),
		"direction": Vector2.RIGHT, "walkable": Rect2i(4, 12, 60, 25),
		"beans_random": 8, "exit": {"rect": Rect2i(62,22,3,5), "target": &"forest"},
		"npcs": [{"id": &"keti", "kind": &"keti", "position": Vector2(42.5,24.5)}], "enemy_spawns": [], "triggers": [],
	},
	&"forest": {
		"title": "森林与断桥", "scene": "res://game/maps/levels/forest.tscn", "size": Vector2i(100, 60), "spawn": Vector2(7.5, 30.5),
		"direction": Vector2.RIGHT, "walkable": Rect2i(2, 2, 96, 56),
		...
		"exit": {"rect": Rect2i(55,0,5,3), "target": &"cave"},
	...
	&"cave": {
		"title": "横向洞窟", "scene": "res://game/maps/levels/cave.tscn", "size": Vector2i(64, 32), "spawn": Vector2(6.5,16.5),
		"direction": Vector2.RIGHT, "walkable": Rect2i(2,8,60,17),
		"beans": [Vector2i(9,16),Vector2i(15,18),Vector2i(22,21),Vector2i(28,10),Vector2i(38,22),Vector2i(48,17)],
		"exit": {"rect": Rect2i(1,14,3,5), "target": &"forest", "entry": &"forest_cave_return"},
