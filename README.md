...
N4：地图、机关、会话与存档已完成，等待制作人审阅。

运行主场景会进入教学地图：WASD/方向键转向，J/空格吐出，Q/E 切换胃袋，K 断尾，F 放置节点。N4 审阅入口中，F1–F4 可明确绕过尚未接入的对白切换四张地图，1/2/3 选择存档槽，F5 保存、F6 载入、F9 从检查点重试；这些跨图键只用于阶段审阅，不代表剧情通关。
