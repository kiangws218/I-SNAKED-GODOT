...
N7 第一章剧情、状态、存档恢复和自动回归已经完成。当前已接入制作人确认的 UI/HUD 视觉基线，下一轮将实现完整开始/暂停菜单、音乐与音效设置、任务栏和胃袋图标轮播，详细边界见 `UI_HUD_HANDOFF.md`。
...
- `UI_HUD_HANDOFF.md`：下一轮完整菜单、设置、HUD、已选素材、编辑方式和验收门禁。
